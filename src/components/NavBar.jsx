...
const NavBar = ({smallScreen, handleSmallScreen, mainpage, onSearchSubmit}) => {
  ...
  return (
    <>
      ...
      <div className='flex w-full px-5 md:px-24 py-5 plus-bolder'>
       ...
       {mainpage? <div className='w-full px-10'>
        ...
        <div className='hidden md:flex justify-end w-full items-center gap-10 text-lg font-medium '>
          <p className='flex items-center gap-1'>Explore <i className="fa-solid fa-chevron-down"></i></p>
          <p>License</p>
        ...
        {smallScreen ? 
        <div className='text-white text-xl px-2'><i className="fa-solid fa-upload"></i></div> :
        <button className='px-7 py-2.5 bg-white text-black font-medium rounded-md md:ml-5'>Upload</button>
        }
